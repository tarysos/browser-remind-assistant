...
export function getNotificationId(reminderId: string): string {
...
/** 取得通知標題前綴（依觸發原因） */
function getPrefix(result: TriggerResult): string {
...
/** 清除通知 */
export async function clearNotification(reminderId: string): Promise<void> {
...
export function parseNotificationId(notifId: string): string | null {
...
export function setupNotificationListeners(
  onAction: (reminderId: string, action: NotificationAction) => void,
): void {
  // 點擊通知按鈕
