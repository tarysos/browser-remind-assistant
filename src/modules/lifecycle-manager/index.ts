...
import { evaluateAll, findMissedReminders } from '../trigger-evaluator/index.js';
 ...
 * 回傳需補提醒的 reminder 清單
 */
export async function performStartupRebuild(): Promise<Reminder[]> {
 ...
 * 設定 startup 監聽（瀏覽器啟動）
 */
export function setupStartupListener(onStartup: () => void): void {
